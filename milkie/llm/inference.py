...
def chatStream(
    ...
    messageTemplates = []
    if systemPrompt:
        messageTemplates.append(ChatMessage(content=systemPrompt, role=MessageRole.SYSTEM))
    
    messageTemplates.append(ChatMessage(content=prompt, role=MessageRole.USER))
